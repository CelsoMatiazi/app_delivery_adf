  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () async {
        ...
        final orderProductResult = await Navigator.of(context).pushNamed('/product_detail',
            arguments: {
              'product' : product,
              'order' : orderProduct
        ...
        if(orderProductResult != null){
          controller.addOrderUpdate(orderProductResult as OrderProductDto);
        }
      },
      child: Padding(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.only(bottom: 8),
                    child: Text(product.description, style: context.textStyles.textRegular.copyWith(fontSize: 14),),
                  ),
                  Padding(
                    padding: const EdgeInsets.only(bottom: 8),
